...
export function DevelopmentCalculator() {
  ...
  return (
    <div className="development-calculator">
      <h2>Hotel Development REIT/FIBRA Calculator</h2>
      <p className="calculator-description">
        Model hotel acquisition and renovation projects structured for REIT/FIBRA investment vehicles.
      </p>
